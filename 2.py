...
#########        
 ...
 #########       
        ...
        error_dialog.setWindowIcon(QIcon('"C:/Users/DELL/Desktop/brain-tumor-detection-master/"'))
...
#button call
    ...
    def setImage(self):
        ...
        import cv2
        global a
        fileName, _ = QtWidgets.QFileDialog.getOpenFileName(None, "Select Image", "/brain-tumor-detection-master/brain_tumor/Testing",
    ...
    def saving(self):
        ...
        if fname:
            ...
            error_dialog = QtWidgets.QErrorMessage()
            error_dialog.setWindowTitle('Image processing tool')
            error_dialog.setWindowIcon(QIcon("/brain-tumor-detection-master/finaldata/"))
